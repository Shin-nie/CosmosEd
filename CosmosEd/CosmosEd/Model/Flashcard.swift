...
//  Next, create a base class Flashcard that conforms to the FlashcardTask protocol. 
//  This class will implement the properties & methods defined in the protocol.
